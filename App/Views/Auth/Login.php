                ...
                <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            ...
                            <form class="row g-3 needs-validation" action="/check" method="post" novalidate>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <button class="btn btn-primary w-100 mt-3" name="login" type="submit">Đăng nhập</button>
                                </div>
                                <div class="col-12">
                                    <p class="small mb-0">Bạn chưa có tài khoản? <a href="/dang-ky">Tạo tài khoản</a>
                                    <p class="small mb-0">Bạn quên mật khẩu rồi ư! <a href="/quen-mat-khau">Quên mật khẩu</a>
                                    </p>
                                </div>
                            </form>
                        </div>
...
<script>
    ...
    <?= show_toast('invalid_login','error','Thất bại') ?>
    <?= show_toast('isvalid_register')?>
    <?= show_toast('isvalid_code')?>
    <?= show_toast('isvalid_logout','info','Thông báo') ?>
    <?= show_toast('issend') ?>
