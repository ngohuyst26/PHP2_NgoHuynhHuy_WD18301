                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                        ...
                        <div class="d-flex justify-content-center py-4">
                            <a href="/dang-ky" class="logo d-flex align-items-center w-auto">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pt-4 pb-2">
                                    ...
                                    <p class="text-center small">Nhập các thông tin của bạn để tạo tài khoản</p>
                                </div>
...
<script>
    ...
    <?= show_toast('invalid_register','error','Thất bại') ?>
</script>
</body>
